/* Vercel serverless function: saves one completed assessment as a private
   Blob. Runs only when deployed on Vercel (the static/serverless hosting
   model doesn't execute server.js — see server.js for the equivalent local
